...
def read_gray():
    ...
    base="C:/Users/jackc/Documents/Machine Learning/Kaggle competitions/02 Car driven/imgs/train" #Path of the image dataset
    image_data=[]
    label_data=[]
...
def read_color():    
    ...
    path="C:/Users/jackc/Documents/Machine Learning/Kaggle competitions/02 Car driven/imgs/train" #Path of the image dataset
    image_data=[]
    label_data=[]
    for i in range(img_train):
